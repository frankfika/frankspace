  ...
  return (
    <html lang="zh-CN">
      <body className={`${fontSans.variable} ${fontMono.variable} antialiased bg-background text-foreground`}>
        ...
        <header className="container flex items-center justify-between py-6 border-b" style={{ borderColor: 'var(--border)' }}>
          <Link href="/" className="font-mono text-sm text-white">Chen Fang</Link>
